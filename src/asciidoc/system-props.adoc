...
There is feature for colorful console output during executing serenity tests. To enable it you should provide variable +serenity.console.colors = true+, by default it is turned off.
Possible values are:
