...
Generally in annotations you should use name of issues according to mask #(NAME)(-)(NUMBER), link will be created to (NAME)(-)(NUMBER),for example if you will use #MP-14, you will find link to http./../905, if you will use #905 you will find link to http./../905 and so on.
...
.Here you can see report with test cases linked to issues
...
Also you can use the `@issue` annotation to link scenarios with issues when using JBehave, as illustrated here:
